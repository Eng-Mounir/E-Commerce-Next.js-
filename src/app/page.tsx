...
export default function Home() {
  return (
    <>
      <section className="flex flex-col items-center px-8 gap-6 w-4xl max-w-4xl h-60.25 mx-auto">
        {/* Heading */}
        ...
        <div className="flex flex-row justify-center items-center gap-4 pt-4 w-208 h-17">
          {/* Shop Now Button */}
          <button className="bg-black text-white rounded-lg px-[33.21px] py-3 w-[140.41px] h-12 flex items-center justify-center text-[15.1px] font-normal leading-6 hover:bg-gray-800 transition">
            Shop Now
          </button>
